...
/* Query A1: Enter a function that calculates the total cost 
of all animal rescues in the PETRESCUE table.*/

SELECT SUM  (COST)
FROM PETRESCUE;

/* Query A2: Enter a function that displays the total cost of all 
animal rescues in the PETRESCUE table in a column 
called SUM_OF_COST.*/
...
/* Query A4: Enter a function that displays the average cost 
of animals rescued.*/
...
time the animals have been rescued; the difference between
 today’s date and the rescue date.*/
